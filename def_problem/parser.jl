...
function is_operator(symbol::Symbol)
    return symbol in (:+, :-, :*, :/, :^, :<, :>, :<=, :>=, :(==), :!=, :&&, :||, :|, :&, :<<, :>>, :%, :÷, :log, :sin, :sinh, :sinh, :sinpi, :sincosd, :sincospi, :asin, :asind, :asinh, :cos, :cosh, :cosc, :acos, :acosh, :acosd, :cospi, :tan, :tanh, :tanpi, :tand, :cot, :coth, :cotd, :acot, :acoth, :acotd, :argmax, :argmin)
end
